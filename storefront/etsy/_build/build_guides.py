...
GUIDES = {
    "01-freelancer-income-tax-tracker": dict(
        ...
        tabs=[("Start Here", "The same steps as this guide, inside the file."),
              ("Dashboard", "Income, all expenses, income minus deductible expenses, tax set aside, tax paid and unpaid invoices for the year, plus a monthly chart."),
              ...
              ("Monthly & Tax", "Income minus deductible expenses, and your tax set-aside, by month and by quarter. Record the tax payments you make here."),
        ...
        tips=["Start a fresh copy of the file for each tax year.",
              ...
              "The year total always equals your % of the whole year's income minus deductible expenses.",
              ...
              "An expense with no category, or a category not listed on Setup, counts as 0% deductible until you pick one.",
    ...
    "03-debt-payoff-planner": dict(
        ...
        tabs=[("Start Here", "The same steps as this guide, inside the file."),
              ...
              ("Progress Log", "Write down what you really owe each month and see your progress as a percentage paid off.")],
